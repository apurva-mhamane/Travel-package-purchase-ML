...
class Prediction:
    ...
    def Predict_class(self,features_df):
        try:
            preprocessor_path=r"C:\Users\Dell\OneDrive\Desktop\Apurva_KJ\KJSIT_Projects\Travel-Package-Purchase-Project-using-CICD-Pipeline-main\Artifacts\Preprocessor.pkl"
            model_path=r"C:\Users\Dell\OneDrive\Desktop\Apurva_KJ\KJSIT_Projects\Travel-Package-Purchase-Project-using-CICD-Pipeline-main\Artifacts\Model.pkl"
