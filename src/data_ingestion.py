...
class DataIngestion:
    ...
    def Initiate_data_ingestion(self):
         ...
         try:
              data=pd.read_csv(r"C:\Users\Dell\OneDrive\Desktop\Apurva_KJ\KJSIT_Projects\Travel-Package-Purchase-Project-using-CICD-Pipeline-main\data\tour_package.csv")
